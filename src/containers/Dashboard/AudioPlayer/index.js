    ...
    render() {
      const {navigation}=this.props;
        return (
            ...
            <View style={{height:40,backgroundColor:'#939ceb',flexDirection:'row'}}>
              <TouchableHighlight style={{width:30,height:30,padding:5}} onPress={()=>navigation.goBack(null)} underlayColor={'transparent'}>
