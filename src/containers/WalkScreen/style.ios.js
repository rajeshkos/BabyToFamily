...
var styles = StyleSheet.create({
  ...
  spexBox: {
    zIndex: 3, alignItems:'center' ,justifyContent: 'center', alignItems: 'center', left: 0, right: 0, top: 0, bottom:0, position: 'absolute', alignSelf: 'center'
  },
  feed: {zIndex: 5,  left: width/2.15, right: 0, top: height/3.3, bottom:0, position: 'absolute'},
  feedBox: {
