...
class WalkScreen extends Component {
  ...
  render() {
    ...
    return (
      <View style={{flex:1, backgroundColor:'#B5BBEF'}}>
        <View  style={styles.blueBg}>
          <View style={styles.babyWrap}>
            <Image style={styles.mainBaby} source={require('./Images/intro1/baby.png')}/>
            <View style={styles.slideWrap}>
              ...
              >
                ...
                <View style={styles.slide}>
                  <View style={styles.ImageWraper}>
                    <View level={2} style={styles.cloudWrap}><Image style={styles.cloud} source={require('./Images/cloud.png')}/></View>
                    <View level={2} style={styles.spexBox}><Image level={10} style={styles.specs} source={require('./Images/intro2/specs.png')}/></View>
                    <View level={5} style={styles.elmentsWrap}>
                      <Image level={10} style={styles.tag} source={require('./Images/intro2/baby_story.png')}/>
                      <Image level={10} style={styles.heart} source={require('./Images/intro2/heart.png')}/>


                      <Image level={10} style={styles.twitter} source={require('./Images/intro2/twiter.png')}/>
                      <Image level={10} style={styles.facebook} source={require('./Images/intro2/fb.png')}/>

                      <Image level={10} style={styles.video} source={require('./Images/intro2/camera.png')}/>
                      <Image level={10} style={styles.star} source={require('./Images/intro2/star.png')}/>
                    </View>
                  </View>
                ...
                <View style={styles.slide}>
                  <View style={styles.ImageWraper}>
                    ...
                    <View level={15} style={styles.elmentsWrap}>
                      <View level={2} style={styles.grandBox}>
                      ...
                      <View level={2} style={styles.babyBox}>
                      ...
                      <View level={2} style={styles.parentBox}>
                ...
                <View style={styles.slide}>
                  <View style={styles.ImageWraper}>
                    <View level={2} style={styles.cloudWrap}><Image style={styles.cloud} source={require('./Images/cloud.png')}/></View>
                    <View level={2} style={styles.feedBox}><Image level={10} style={styles.feed} source={require('./Images/intro4/feeding.png')}/></View>
                ...
                <View style={styles.slide}>
                  <View style={styles.ImageWraper}>
                    ...
                    <View level={25} style={styles.elmentsWrap}>
                      ...
                      <Image level={15} style={styles.tag4} source={require('./Images/intro2/baby_shop.png')}/>
